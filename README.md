...
![Smoothing comparison plot](src/Smoothing_plot.png)

> Example visualization of raw vs. smoothed trajectories (Butterworth/Savitzky–Golay/Gaussian).

<details>
<summary>Preview keypoint overlay video</summary>
...
der the hood when `static_image_mode=False` (the default setting). This provides excellent results for smoothing raw keypoint trajectories without additional post-processing.
